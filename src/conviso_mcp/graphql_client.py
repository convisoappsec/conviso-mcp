...
if __name__ == "__main__":
    ...
    dotenv.load_dotenv()
    # Exemplo de uso (comentado para evitar execução automática)
    client = GraphQLClient(endpoint="https://staging.convisoappsec.com/graphql", api_key=os.environ.get("CONVISO_API_KEY"))

    #data = client.get_issue_by_id(135606, True)
    #print(data)

    '''data = client.get_issue_by_id(135606)
    print(data)
    ...
    #t = client.get_issues(418, "", 1, 50)
    #print(t)

    #data = client.get_projects(248, 1, 100, "mode")
    #print(data)

    '''data = client.get_asset_by_id(27825)# client.list_assets_by_company(248)# client.get_issues(248, "", 1, 50, 0) #3263)
    print(data)

    data = client.list_allocated_analyses(1, 10)
    print(data)

    data = client.get_top_vulnerabilities(248)
    print(data)

    data = client.get_issues_stats(248)
    print(data)
